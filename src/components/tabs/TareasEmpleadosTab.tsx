    ...
    return (
      <div className="space-y-4">
        ...
        {(() => {
          ...
          // Agrupar tareas hechas por persona
              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-2.5 rounded-full bg-muted overflow-hidden">
                    <div
                      className="h-full rounded-full bg-[hsl(142,60%,45%)] transition-all duration-500"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {Object.entries(porTurno).map(([turno, count]) => (
                        <Badge key={turno} variant="outline" className="text-xs capitalize">
                          {turno}: {count}
                        </Badge>
                      ))}
                    </div>
