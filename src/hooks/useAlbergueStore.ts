...
import { Huesped, ComedorEntry, ProximaLlegada, Incidencia, ROOMS, Dieta, UserAccount, UserRole, IncidentType } from '@/types';
...
export function useAlbergueStore() {
  ...
  const [incidencias, setIncidencias] = useState<Incidencia[]>(() => loadFromStorage('incidencias', []));
